...
class __TwigTemplate_261280257adaa7931648b753ddeb606c5dcaf9a29bf6135b080341bfb52fd8d4 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t<a href=\"";
            // line 22
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("design.show", ["id" => twig_get_attribute($this->env, $this->source, $context["amenagement"], "id", [], "any", false, false, false, 22), "slug" => twig_get_attribute($this->env, $this->source, $context["amenagement"], "slug", [], "any", false, false, false, 22)]), "html", null, true);
            echo "\">";
...
";
    ...
    {
        return array (  139 => 30,  127 => 24,  120 => 22,  115 => 19,  110 => 17,  107 => 16,  105 => 15,  101 => 13,  97 => 12,  89 => 6,  79 => 5,  59 => 2,  36 => 1,);
    }
...
\t\t\t\t\t\t\t<img src \"/images/projets/{{amenagement.filename}}\" alt \"\">
\t\t\t\t\t\t{% endif %}
\t\t\t\t\t\t<div class=\"card-body\">
