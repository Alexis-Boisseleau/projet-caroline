...
class __TwigTemplate_af60a72d835d12c0c2897b8f48159fe5405d16edd42e4b4ffa808bbd0a9ed3ce extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t\t<a href=\"";
                // line 19
                echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("archi.show", ["id" => twig_get_attribute($this->env, $this->source, $context["amenagement"], "id", [], "any", false, false, false, 19), "slug" => twig_get_attribute($this->env, $this->source, $context["amenagement"], "slug", [], "any", false, false, false, 19)]), "html", null, true);
                echo "\" class=\" images__link\">";
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["amenagement"], "title", [], "any", false, false, false, 19), "html", null, true);
                echo "
...
";
    ...
    {
        return array (  138 => 32,  127 => 26,  115 => 19,  110 => 17,  107 => 16,  105 => 15,  101 => 13,  97 => 12,  89 => 6,  79 => 5,  59 => 2,  36 => 1,);
    }
...
\t\t\t\t\t\t\t<div class=\"images__overlay\">
\t\t\t\t\t\t\t\t<a href=\"{{path('archi.show',{id :amenagement.id, slug: amenagement.slug})}}\" class=\" images__link\">{{amenagement.title}}
