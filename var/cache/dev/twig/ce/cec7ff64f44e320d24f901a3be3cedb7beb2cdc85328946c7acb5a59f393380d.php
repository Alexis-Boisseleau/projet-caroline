...
class __TwigTemplate_00d021f77c451a47325c8727f6a57ee3d8b9feeb55f89c2626a6334a82e44cbe extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t";
            ...
            if (twig_get_attribute($this->env, $this->source, $context["amenagement"], "filename", [], "any", false, false, false, 15)) {
                // line 16
                echo "
\t\t\t\t\t\t\t<img src=\"../../public/images/projets/";
                // line 17
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["amenagement"], "filename", [], "any", false, false, false, 17), "html", null, true);
...
\t\t\t\t\t\t\t\t<a href=\"";
            // line 22
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("archi.show", ["id" => twig_get_attribute($this->env, $this->source, $context["amenagement"], "id", [], "any", false, false, false, 22), "slug" => twig_get_attribute($this->env, $this->source, $context["amenagement"], "slug", [], "any", false, false, false, 22)]), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["amenagement"], "title", [], "any", false, false, false, 22), "html", null, true);
            echo "
\t\t\t\t\t\t\t\t</a>
\t\t\t\t\t\t\t\t<p class=\"card-text\">";
            // line 24
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["amenagement"], "description", [], "any", false, false, false, 24), "html", null, true);
            echo "</p>
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t</div>
\t\t\t\t\t</div>
...
";
    ...
    {
        return array (  141 => 32,  127 => 24,  120 => 22,  115 => 19,  110 => 17,  107 => 16,  105 => 15,  101 => 13,  97 => 12,  89 => 6,  79 => 5,  59 => 2,  36 => 1,);
    }
...
\t\t\t\t\t\t\t<img src=\"../../public/images/projets/{{amenagement.filename}}\" class=\" card-img-top\" alt=\"  \">
\t\t\t\t\t\t{% endif %}
