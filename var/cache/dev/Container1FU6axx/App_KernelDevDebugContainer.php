...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'Vich\\UploaderBundle\\Naming\\UniqidNamer.projets_image' => 'getUniqidNamer_ProjetsImageService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('projets_image', $d, $e, $f));
        ...
        $c->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('projets_image', $d, $e, $f));
        $c->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('projets_image', $d, $e, $f));
        ...
        return [
            ...
            'vich_uploader.mappings' => [
                'projets_image' => [
                    ...
                    'namer' => [
                        'service' => 'Vich\\UploaderBundle\\Naming\\UniqidNamer.projets_image',
                        'options' => [
