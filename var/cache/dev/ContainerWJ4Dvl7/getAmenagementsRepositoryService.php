 ...
 */
class getAmenagementsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AmenagementsRepository' shared autowired service.
     *
     * @return \App\Repository\AmenagementsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AmenagementsRepository.php';

        return $container->privates['App\\Repository\\AmenagementsRepository'] = new \App\Repository\AmenagementsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
